	...
	return (
		<div className="flex justify-center">
			{product ? (
					...
					<div>
						...
						<div className="mt-10">
							<div className="flex items-center gap-10">
								...
								<select onChange={(e)=>setSize(e.target.value)} className="w-52 p-2 border border-gray-500 rounded text-lg text-gray-600">
              ...
              <div className="mt-5">
                <p className="text-2xl font-bold text-green-800">Rs {size==="250" ? product.min_price : product.max_price}</p>
              </div>
              <div className="mt-5 flex gap-3">
                <QuantitySelector quantity={quantity} setQuantity={setQuantity} />
                <button className="bg-green-800 text-white font-bold text-lg p-2 hover:cursor-pointer">ADD TO CART</button>
              </div>
